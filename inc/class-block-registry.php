...
.block-editor-block-list__layout ul.is-style-checkmark-list li {
	padding-inline-start: 1ch;
		...
		'circled-primary'     => array(
			'config' => array(
				'block'       => 'core/list',
				'name'        => 'circled-primary',
				'label'       => 'Circled Primary',
				'type'        => 'variant',
				'description' => 'Liste mit Primary-Kreisen und Häkchen',
			),
			'css' => 'ul.wp-block-list.is-style-circled-primary,
ul.is-style-circled-primary {
	padding: 0;
}
.wp-block-list.is-style-circled-primary li,
ul.is-style-circled-primary li {
	list-style: none;
	position: relative;
	padding-left: 1.75em;
	padding-bottom: 0.2em;
}
.wp-block-list.is-style-circled-primary li::before,
ul.is-style-circled-primary li::before {
	content: "";
	position: absolute;
	left: 0;
	top: 0.2em;
...
.block-editor-block-list__layout ul.is-style-circled-primary {
	padding: 0;
}
.block-editor-block-list__layout ul.is-style-circled-primary li {
	list-style: none;
	position: relative;
	padding-left: 1.75em;
	padding-bottom: 0.2em;
}
.block-editor-block-list__layout ul.is-style-circled-primary li::before {
	content: "";
	position: absolute;
	left: 0;
	top: 0.2em;
	...
	background-image: url("data:image/svg+xml,%3Csvg%20xmlns=\'http://www.w3.org/2000/svg\'%20viewBox=\'0%200%2016%2016\'%3E%3Cpath%20fill=\'none\'%20stroke=\'%23fff\'%20stroke-width=\'2\'%20d=\'M2%209l4%204%208-8\'/%3E%3C/svg%3E");
		...
		'circled-secondary'   => array(
			'config' => array(
				'block'       => 'core/list',
				'name'        => 'circled-secondary',
				'label'       => 'Circled Secondary',
				'type'        => 'variant',
				'description' => 'Liste mit Secondary-Kreisen und Häkchen',
			),
			'css' => 'ul.wp-block-list.is-style-circled-secondary,
ul.is-style-circled-secondary {
	padding: 0;
}
.wp-block-list.is-style-circled-secondary li,
ul.is-style-circled-secondary li {
	list-style: none;
	position: relative;
	padding-left: 1.75em;
	padding-bottom: 0.2em;
}
.wp-block-list.is-style-circled-secondary li::before,
ul.is-style-circled-secondary li::before {
	content: "";
	position: absolute;
	left: 0;
	top: 0.2em;
...
.block-editor-block-list__layout ul.is-style-circled-secondary {
	padding: 0;
}
.block-editor-block-list__layout ul.is-style-circled-secondary li {
	list-style: none;
	position: relative;
	padding-left: 1.75em;
	padding-bottom: 0.2em;
}
.block-editor-block-list__layout ul.is-style-circled-secondary li::before {
	content: "";
	position: absolute;
	left: 0;
	top: 0.2em;
